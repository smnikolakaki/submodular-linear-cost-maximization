...
class PartitionMatroidGreedy(object):
    """
    greedy algorithm implementation for the partition matroid constraint
    """
    ...
    def find_greedy_element(self, E, skills_covered):
        ...
        :return e:
        """
        greedy_element = max(E, key=lambda x: self.original_greedy_criterion(skills_covered, x)) 
